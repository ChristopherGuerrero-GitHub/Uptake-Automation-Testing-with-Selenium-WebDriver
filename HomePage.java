...
public class HomePage {
	...
	/* 				  HomePage purpose is find all web Elements with tag name "a" */
	/* 				  on the home website and test if each link is valid and   	  */
	/* 				  clickable and then return to source HomePage. 			  */
	/* 																			  */
	...
	/* 				  to the source HomePage is invoked and statistics are 		  */
	/* 				  recorded and printing out on the console.					  */
	/* 																			  */
	...
	/* 				  the target website is verified return to source HompPage.	  */
	/* 				  Record statistics and print results on the display.		  */
	/* 																			  */
	...
	// Create By for web page anchor links
						...
						try {
							...
							if (!w.isDisplayed()) {
								...
								while(!w.isDisplayed()){
									...
									/* Create mouse obj for testDriver object */
								...
								testDriver.navigate().to("https://www.uptake.com/");
								testDriver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
								System.out.println("\n  >>> Navigation HOME click successful.\n");
					    	...
					    	try {
					    		...
					    		FileUtils.copyFile(src, new File("C:\\SeleniumData\\Errors\\webDriverErrorOnWebElement_" + i +".png"));
					    	...
					    	try {
					    		// now copy the  screenshot to desired location using copyFile //method
					    		FileUtils.copyFile(src, new File("C:\\SeleniumData\\Errors\\runtimeErrorOnWebElement_" + i +".png"));
